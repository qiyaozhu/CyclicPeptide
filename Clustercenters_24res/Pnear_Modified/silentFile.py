...
aacode = {'AIB':'X', 'ALA':'A', 'ARG':'R', 'ASN':'N', 'ASP':'D', 'CYS':'C', 'GLN':'Q', 'GLU':'E', 'GLY':'G', 'HIS':'H', 'ILE':'I', 'LEU':'L', 'LYS':'K', 'MET':'M', 'PHE':'F', 'PRO':'P', 'SER':'S', 'THR':'T', 'TRP':'W', 'TYR':'Y', 'VAL':'V', 'DALA':'A', 'DARG':'R', 'DASN':'N', 'DASP':'D', 'DCYS':'C', 'DGLN':'Q', 'DGLU':'E', 'DGLY':'G', 'DHIS':'H', 'DILE':'I', 'DLEU':'L', 'DLYS':'K', 'DMET':'M', 'DPHE':'F', 'DPRO':'P', 'DSER':'S', 'DTHR':'T', 'DTRP':'W', 'DTYR':'Y', 'DVAL':'V'}

name = "clustercenter"+sys.argv[1]+"_0001_0001"
path = 'After_Energy_SA_'+name+'_24res.mat'
...
output = 'After_Energy_SA_'+name+'_24res.txt'
n = len(seq)
...
name = "clustercenter"+sys.argv[1]+"_0001_0001"
path = 'After_RMSD_SA_'+name+'_24res.mat'
mat = scipy.io.loadmat(path)
candPhi = mat["candPhi"]
candPsi = mat["candPsi"]
candCoordinates_x = mat["candCoordinates_x"]
...
seq = sys.argv[2].split('-')
seq = [s.upper() for s in seq]
output = 'After_RMSD_SA_'+name+'_24res.txt'
n = len(seq)
