...
Rnumber = length(candScores)-Enumber;
...
filename = sprintf('After_SA_%s_24res.mat', name);
save(filename, 'candPhi', 'candPsi', 'candOmega', 'candCoordinates_x', 'candCoordinates_y', 'candCoordinates_z', 'candScores');
fprintf('Number of candidates obtained from Energy SA is %d, from RMSD SA is %d.\n', Enumber, Rnumber);
end
