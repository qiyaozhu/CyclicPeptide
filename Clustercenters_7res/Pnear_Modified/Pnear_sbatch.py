...
with open('run_Pnear.sbatch', 'w') as f:
    ...
    f.write('#SBATCH --job-name=PnearFiltering\n')
...
for cand in candidates:
    with open('run_Pnear.sbatch', 'a') as f:
        f.write('srun --mpi=pmi2 /share/apps/rosetta/2020.46.61480/openmpi/intel/2020.46.61480/main/source/bin/rosetta_scripts.mpi.linuxiccrelease @'+cand+'_rosetta.flags\n')
