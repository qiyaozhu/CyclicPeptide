...
bin_class = load('InitialPoints_20residue.mat').bin_class;
...
for bat = 0 : batches
    ...
    parfor pos = 1000*bat+1 : uplim
        ...
        while repeat <= Repeat && goodcount == 0
            ...
            angles = [InitAngles(:,bin(1)); InitAngles(:,bin(2)); InitAngles(:,bin(3)); ...
                ...
                InitAngles(:,bin(19)); InitAngles(:,bin(20))];
            ...
            while i <= M
                ...
                k = k0/(1+b*i/M);
                p = random_move20(k);
                [~, angles_new] = feasible20(p, angles, Boundaries);
    ...
    filename = sprintf('GoodAngles20res_%d.mat', bat+1);
