...
function [p_f, angles_f] = feasible24(p, angles, Boundaries)
...
in_or_not = [inpolygon(phi1, psi1, Boundaries(1,:), Boundaries(2,:)), inpolygon(phi2, psi2, Boundaries(1,:), Boundaries(2,:)), ...
    ...
    inpolygon(phi21, psi21, Boundaries(1,:), Boundaries(2,:)), inpolygon(phi22, psi22, Boundaries(1,:), Boundaries(2,:)), ...
    inpolygon(phi23, psi23, Boundaries(1,:), Boundaries(2,:)), inpolygon(phi24, psi24, Boundaries(1,:), Boundaries(2,:))];
end