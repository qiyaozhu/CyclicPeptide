...
function error = f_cyc20(angles, R_omega, T_CR, T_NR, T_CaR, q)
...
e1 = [1;0;0];
e2 = [0;1;0];
Rotation = s1*s2*s3*s4*s5*s6*s7*s8*s9*s10*s11*s12*s13*s14*s15*s16*s17*s18*s19*s20;
Translation = s1*s2*s3*s4*s5*s6*s7*s8*s9*s10*s11*s12*s13*s14*s15*s16*s17*s18*s19*q + ...
