...
function Energy_15residue_parameter
...
Parameters = load('parameters_combdesign15.mat').Parameters;
...
parfor parind = 1 : size(Parameters,2)
    ...
    for repeat = 1 : Repeat
        % initial angles
        angles = [-1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, ...
            -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17, -1.7, 0.17];
...
save('GoodCount15.mat', 'GoodAngleCount', 'AcceptCounts');
end
